<script lang="ts">
	import { localStorageConfigStore } from '$lib/stores/local-storage-config.js'
	import type { ThemePalletType } from '$lib/types/config'

	const themePallet: ThemePalletType = {
		dark: {
			to: 'light',
			darkMode: false
		},
